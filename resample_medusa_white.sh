...
do
  ...
  do
    CoordInput=$SubjectDir/"$Subject".$Hemisphere.white_orig.164k_fs_LR.coord.gii
    TopoInput=$SubjectDir/"$Subject".$Hemisphere.164k_fs_LR.topo.gii
    SurfaceInput=$SubjectDir/"$Subject".$Hemisphere.white_orig.164k_fs_LR.surf.gii
    ...
    SurfaceOutput=$SubjectDir/"$Subject".$Hemisphere.white_orig.32k_fs_LR.surf.gii
